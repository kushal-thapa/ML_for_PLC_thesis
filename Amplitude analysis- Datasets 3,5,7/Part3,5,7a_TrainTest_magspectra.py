...
mag_spectra = np.load('Dataset3_amp-analysis_mag_spectra_comb_1170Hz.npy')
...
dataset = np.reshape(mag_spectra,(6400,3,1024,1))
m = 'mag_spectra'
...
#         file = open("Datasets3,5,7_TrainTest_magspectra_Results_final.txt", "a+")
