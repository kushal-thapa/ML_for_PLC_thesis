...
dataset_mag = mag_spectra[subset_idx_start:subset_idx_end]
label = label[subset_idx_start:subset_idx_end]
m = 'mag_spectra'

# mean centering and standardization
mean_vals = np.mean(dataset_mag,axis=0)
std_val = np.std(dataset_mag)
dataset = (dataset_mag-mean_vals)/std_val
...
#     file = open("Dataset4_comp_Case2_Results_magspectra_final.txt", "a+")
