...
center_freq = [690,750,810,870, 930, 990, 1050, 1110, 1170, 1230, 1290, 1350, 
               1410, 1470, 1530, 1590, 1650, 1710, 1770, 1830, 1890, 1950, 2010]  # for frequency analysis dataset 
#center_freq = [1170]  ## for amplitude analysis dataset
#amp = [10,20,50,100,250,500,750,1000]   ##

# read raw files from the directory it is stored in 
...
# =============================================================================
#       # Figure to check how the label extraction worked
...
# =============================================================================
#         # Plotting the PLC band for each file (frequency analysis)
...
# =============================================================================
#         # Plotting the PLC band for each file (amplitude analysis)
#         ax[i].plot(filtered_signal,alpha=0.7)
#         if i==7:
#             ax[i].set_xticks([0,200000,400000,600000,800000])
#             ax[i].set_yticks([-2])
...
# =============================================================================
#         # Plotting the spectrogram of each files
...
# =============================================================================
# # Saving datasets (frequency analysis)
...
# =============================================================================
# # Saving datasets (amplitude analysis)
# np.save('Dataset1_amp-analysis_feature_based_dataset_comb_1170Hz',df_feature_based_dataset_comb)
# np.save('Dataset3_amp-analysis_mag_spectra_comb_1170Hz',df_mag_spectra_comb)
# np.save('Dataset5_amp-analysis_real_imag_spectra_comb_1170Hz',df_real_imag_spectra_comb)
# np.save('Dataset7_amp-analysis_time_series_dataset_comb_1170Hz',df_time_series_dataset)
# np.save('Label_amp-analysis_label_comb_1170Hz_new',df_label_comb)
# =============================================================================

# =============================================================================
# # Visualization of the joint spectrogram
# num = int((i+1)*800)
# spectrogram = np.reshape(df_mag_spectra_comb,(int(num*3),1024))
